...
const STATIC_PARTNERS = [
    ...
    { id: 4, type: 'government', name: 'Standards Org. of Nigeria (SON)', desc: 'Sets and enforces product quality benchmarks for fortified foods, ensuring compliance with Nigerian and international standards.', logo: '/son-logo.png' },
